...
if imagenet then
   ...
   model8 = '/home/soumith/local/fbcode2/deeplearning/experimental/soumith/eyescream/cifar_8x8_600_1200_adversarial.net'
   -- model8 = '/home/soumith/local/fbcode2/deeplearning/experimental/soumith/eyescream/stl10_8x8_1000_1000_adversarial.net'
   model16 = '/gfsai-bistro/ai-group/bistro/gpu/soumith/20150530/Eyescream_8_16_run8.14_13_29.QVzwIsXM/imgslogs/model_23.t7'
   model32 = '/gfsai-bistro/ai-group/bistro/gpu/soumith/20150523/Eyescream_4_8_16_32_run7.21_53_45.PTeuxS5j/imgslogs/model_23.t7'
...
-- cifar lsun lsun
   ...
   model16 = '/gfsai-bistro/ai-group/bistro/gpu/soumith/20150531/Eyescream_lsun_8_16_run13.20_52_45.r5LUGY8D/imgslogs/model_24.t7'
   model32 = '/gfsai-bistro/ai-group/bistro/gpu/soumith/20150602/Eyescream_lsun_16_32_run22.23_31_38.79dr8601/imgslogs/model_11.t7'
   model64 = '/home/soumith/local/fbcode2/deeplearning/experimental/soumith/eyescream/32_64.net'
end

m1=torch.load(model8).G
print(#m1.modules[1].weight)
...
rands[2] = torch.zeros(n,1,16,16):uniform(-1,1)
...
s1 = m1:forward(rands[1]:cuda():view(n,100))
print(#s1)
...
if do64 then
   ...
   s5_i = s5_i:cuda()
   s5 = m4:forward({rands[5]:cuda(), s5_i:view(n,3,128,128)})
