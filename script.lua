...
mo = torch.load('14x28_mods_clean.t7')
...
l1 = nn.SpatialConvolution(10, 784, 1, 1)
...
torch.save('14x28_model.t7', m);

one_hot = torch.zeros(1,10,1,1)
one_hot[1][1][1][1] = 1
noise = torch.zeros(1,1,28,28):uniform()

out = m:forward({torch.randn(1,3,28,28), noise, one_hot})
print(#out)
