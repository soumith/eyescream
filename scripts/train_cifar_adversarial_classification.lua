...
adversarial = require 'train.adversarial_classification'
...
if opt.network == '' then
  ...
  x_D = nn.Identity()()
  d1 = nn.Linear(input_sz, numhid)(nn.Reshape(input_sz)(x_D))
  ...
  local numhid = 8000
  x_G = nn.Identity()()
  g1 = nn.Linear(opt.noiseDim, numhid)(x_G)
